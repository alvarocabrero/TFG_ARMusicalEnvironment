...
/// </summary>
public class PersonalizeTrackableEventHandler : MonoBehaviour
{
    ...
    protected ImageTargetBehaviour mTrackableBehaviour;
    protected ImageTargetBehaviour.Status m_PreviousStatus;
    protected ImageTargetBehaviour.Status m_NewStatus;
    ...
    internal AudioSource GetAudioComponent()
    {
        return mTrackableBehaviour.GetComponentInChildren<AudioSource>(true);
    }
    internal Renderer[] GetRendererComponents()
    {
        return mTrackableBehaviour.GetComponentsInChildren<Renderer>(true);
    }
    ...
    protected virtual void OnTrackingFound()
    {
        ...
        if (mTrackableBehaviour)
        {
            ...
            var audioComponents = mTrackableBehaviour.GetComponentInChildren<AudioSource>(true);
            ...
            if (PlayerPrefs.GetInt("modo").Equals(Controller_Gestor_Sesion.MODO_DEMO))
            {
                audioComponents.mute = false;
            }
            else
            {
                // Disable audioSource:
                audioComponents.enabled = true;
            }
        }
    ...
    protected virtual void OnTrackingLost()
    {
        if (mTrackableBehaviour)
        {
            ...
            else
            {
                ...
                audioComponents.enabled = false;
            }

            //TargetScreenCoords targetScreenCoords = mTrackableBehaviour.GetComponent<TargetScreenCoords>();
            // targetScreenCoords.changeStatus();
        }
